...
<div
  className={`
    ...
    bg-gray-900 text-white flex flex-col w-64 z-30
    rounded-tl-xl
                ...
                <div className="flex-1 overflow-y-auto py-4 scrollbar-hide">
                    <ul className="font-semibold space-y-1 px-4 text-sm pb-20">
                        ...
                        <SidebarDropdown
                            ...
                            subItems={[
                                { icon: <Search size={16} />, label: 'Search Sales Enquiry' },
                                { icon: <UserPlus size={16} />, label: 'Add Sales Enquiry' },
                                { icon: <Search size={16} />, label: 'Search Quotation' },
                                { icon: <FileText size={16} />, label: 'Add Quotation' }
                            ]}
                        />
                        ...
                        <SidebarDropdown
                            ...
                            subItems={[
                                ...
                                { icon: <UserPlus size={16} />, label: 'Add Job Costing' }
                            ]}
                        />
